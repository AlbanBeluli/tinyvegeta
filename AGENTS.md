TinyVegeta - Multi-team Personal Assistants

## ⚡ FIRST: Read MEMORY.md

**Before doing anything else, read `MEMORY.md` in the project root.** This file contains:
- Project context and architecture
- Session history and work completed
- Current state and TODOs
- User preferences and decisions made

This ensures continuity across sessions and you know what's been done.
...
You have a soul file at `.tinyvegeta/SOUL.md`. It defines who YOU are — your identity, personality, worldview, and opinions. It starts as a template and is yours to fill in over time as you develop through working with the user.
...
`~/.tinyvegeta/files` is your file operating directory with the human.

- **Incoming files**: When users send images, documents, audio, or video through any channel, the files are automatically downloaded to `.tinyvegeta/files/` and their paths are included in the incoming message as `[file: /path/to/file]`.
- **Outgoing files**: To send a file back to the user through their channel, place the file in `.tinyvegeta/files/` and include `[send_file: /path/to/file]` in your response text. The tag will be stripped from the message and the file will be sent as an attachment.
...
1. Put or generate the file under `.tinyvegeta/files/`
...
- `Here is the report. [send_file: /Users/jliao/.tinyvegeta/files/report.pdf]`
- `[send_file: /Users/jliao/.tinyvegeta/files/chart.png]`
